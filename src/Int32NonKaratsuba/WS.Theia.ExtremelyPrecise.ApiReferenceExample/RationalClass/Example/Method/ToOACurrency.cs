...
namespace WS.Theia.ExtremelyPrecise.ApiReferenceExample.RationalClass.Example.Method {
	...
	public class ToOACurrency {
		...
		// or exception.
		public void ShowRationalToOACurrency(Rational Argument) {
		...
		public void Case1() {
			...
			ShowRationalToOACurrency(1.0000000000000000000000000000M);
			ShowRationalToOACurrency(100000000000000M);
			ShowRationalToOACurrency(100000000000000.00000000000000M);
			ShowRationalToOACurrency(10000000000000000000000000000M);
			ShowRationalToOACurrency(0.000000000123456789M);
			ShowRationalToOACurrency(0.123456789M);
			ShowRationalToOACurrency(123456789M);
			ShowRationalToOACurrency(123456789000000000M);
	...
	/*
	This example of the Rational.ToOACurrency( ) method generates
