...
namespace WS.Theia.ExtremelyPrecise.ApiReferenceExample.MathClass.Example.Method {
	...
	public class Cosh {
		...
		void UseTwoArgs(Rational argX,Rational argY) {
		...
		/*
		This example of hyperbolic Math.Sinh( Rational ) and Math.Cosh( Rational )
		generates the following output.
