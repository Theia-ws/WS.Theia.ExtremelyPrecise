...
namespace WS.Theia.ExtremelyPrecise {
	...
	public struct Rational:IComparable, IComparable<Rational>, IEquatable<Rational>, IFormattable {
		...
		public static byte ToByte(Rational value) {
			...
			return (byte)(value.Numerator/value.Denominator).Value;
#endif
		}
		...
		public static short ToInt16(Rational value) {
			...
			var result = (short)(value.Numerator/value.Denominator).Value;
			if(value.Sign) {
				result*=-1;
			}
			return result;
		...
		public static int ToInt32(Rational value) {
			...
			var result = (int)(value.Numerator/value.Denominator).Value;
			if(value.Sign) {
				result*=-1;
			}
			return result;
		...
		public static long ToInt64(Rational value) {
			...
			var result = (long)(value.Numerator/value.Denominator).Value;
			if(value.Sign) {
				result*=-1;
			}
			return result;
		...
		public static sbyte ToSByte(Rational value) {
			...
			var result = (sbyte)(value.Numerator/value.Denominator).Value;
			if(value.Sign) {
				result*=-1;
			}
			return result;
		...
		public static ushort ToUInt16(Rational value) {
			...
			return (ushort)(value.Numerator/value.Denominator).Value;
#endif
		}
		...
		public static uint ToUInt32(Rational value) {
			...
			return (uint)(value.Numerator/value.Denominator).Value;
#endif
		}
		...
		public static ulong ToUInt64(Rational value) {
			...
			return (ulong)(value.Numerator/value.Denominator).Value;
#endif
		}
